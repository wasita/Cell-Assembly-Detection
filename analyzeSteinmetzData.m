        ...
        for binStep = timeWindows
            ...
            try
                ...
                if ismember(session, ACA_sessions)
                    ...
                    % bin into 10 ms bins
                    ACA_mat = nan(length(ACA_timesPerCluster),binSize+1); % 154 x 270265
                    ...
                    saveas(gcf, [base_path, '/figures/AssemblyPatterns/', ...
                        patternMethod, '/', currSession, '_ACA_assembly_patterns_', ...
                ...
                if ismember(session, CA3_sessions)
                    ...
                    saveas(gcf, [base_path, '/figures/AssemblyPatterns/', patternMethod, ...
                        '/', currSession, '_CA3_assembly_patterns_', ...
                        opts.threshold.method, '_', opts.Patterns.method, '_', 'binStep_', ...
                ...
                if ismember(session, CA1_sessions)
                    ...
                    saveas(gcf, [base_path, '/figures/AssemblyPatterns/', patternMethod, ...
                        '/', currSession, '_CA1_assembly_patterns_', ...
                        opts.threshold.method, '_', opts.Patterns.method, '_', 'binStep_', ...
